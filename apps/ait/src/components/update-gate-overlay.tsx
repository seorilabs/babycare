...
// SDK의 `@seorilabs/platform-sdk/gate-dom`은 DOM 전용이라 RN(Granite) 번들러에
// import하면 깨진다. AIT는 `UpdateGateState` 판정 결과로 자기 화면을 직접
// 그린다(SDK 안내).
...
export function UpdateGateOverlay({
  ...
  return (
    <Modal
      ...
      transparent
      animationType="fade"
      onRequestClose={view.dismissible ? onDismiss : () => {}}>
