...
#
# Firebase iOS 설정(GoogleService-Info.plist)은 저장소에 커밋돼 있고(prod: seorilabs-babycare)
# pbxproj 가 참조하므로 기본적으로 그대로 사용한다.
#   FIREBASE_IOS_GOOGLE_SERVICE_INFO_PLIST_BASE64 — (선택) 설정 시 커밋본을 덮어씀.
