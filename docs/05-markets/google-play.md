...
- Internal testing track: ✅ **`v1.0.9`(최신)** — source `fe2b4b1`, workflow run `31243326802`, AAB `1.0.9`/`1000009`. Android Publisher API 독립 readback에서 `internal` 트랙 `name=1.0.9`, `status=completed`, `versionCodes=['1000009']` 확인(2026-08-08). i18n(ADR 0005) 포함 첫 후보다.
