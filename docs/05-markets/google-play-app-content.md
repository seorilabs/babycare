...
> 2026-08-07 Play Console에 입력·저장하고 초기 설정 11개 완료와 앱 콘텐츠 상태를 readback한 답변 원장이다. 심사 전송과 production 배포는 별도 게이트다.
...
- 생성본을 검토한 뒤 `--apply`를 추가하면 Android Publisher API로 반영한다. 2026-08-07 API 제출과 Play Console 완료 상태 readback을 마쳤다.
