...
- Feature parity source: 수유 4종·좌우 timer, 기저귀 3종, 수면 종류, 체온·복약, 과거 시각·메모, latest 5종 홈, 날짜/작성자/삭제 timeline, 12시간·7일·30일 chart, 전체 구성원·초대 공유·privacy를 AIT RN 0.84 renderer에 반영했다. mobile target RN 0.85를 import하지 않으며 공통 product-core/product-data 계약만 재사용한다
